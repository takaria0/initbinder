#!/bin/bash
#SBATCH --job-name=rfa-diff_6M0J_Cryptic_Allosteric_Site
#SBATCH --partition=gpu
#SBATCH -A ccl_lab_gpu
#SBATCH --gres=gpu:A100:1
#SBATCH --nodes=1 --ntasks=1 --cpus-per-task=4 --mem=32G
#SBATCH --array=1-1
#SBATCH --output=slurm_logs/rfa-diff_6M0J_Cryptic_Allosteric_Site_%A_%a.out --error=slurm_logs/rfa-diff_6M0J_Cryptic_Allosteric_Site_%A_%a.err
...
singularity exec \
    ...
    --bind "/data/homezvol1/inagakit/Projects/epitopeflow_rfa/targets/6M0J/prep":/inputs \
    --bind "/data/homezvol1/inagakit/Projects/epitopeflow_rfa/targets/6M0J/designs/Cryptic_Allosteric_Site/rfa_rfdiff":/outputs \
    --pwd /home \
    ...
    bash -c "echo 'Running RFAntibody RFdiffusion...'; \
                ...
                echo 'Designing for epitope: Cryptic Allosteric Site'; \
