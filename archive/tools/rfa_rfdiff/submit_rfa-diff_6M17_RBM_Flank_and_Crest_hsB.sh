#!/bin/bash
#SBATCH --job-name=rfa-diff_6M17_RBM_Flank_and_Crest_hsB
#SBATCH --partition=gpu
#SBATCH -A ccl_lab_gpu
#SBATCH --gres=gpu:A30:1
#SBATCH --nodes=1 --ntasks=1 --cpus-per-task=1 --mem=16G
#SBATCH --array=1-1
#SBATCH --output=slurm_logs/rfa-diff_6M17_RBM_Flank_and_Crest_hsB_%A_%a.out
#SBATCH --error=slurm_logs/rfa-diff_6M17_RBM_Flank_and_Crest_hsB_%A_%a.err
...
--bind "/data/homezvol1/inagakit/Projects/initbinder/targets/6M17/designs/RBM_Flank_and_Crest/hs-B/rfa_rfdiff":/outputs \
--pwd /home \
...
bash -lc "
    ...
    echo 'Hotspots: E440,E445,E450,E452,E455'
    ...
    ppi.hotspot_res=[E440,E445,E450,E452,E455] \
