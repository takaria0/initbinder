#!/bin/bash
#SBATCH --job-name=rfa-diff_6M17_Receptor_Binding_Motif_Core_hsB
#SBATCH --partition=gpu
#SBATCH -A ccl_lab_gpu
#SBATCH --gres=gpu:A30:1
#SBATCH --nodes=1 --ntasks=1 --cpus-per-task=1 --mem=16G
#SBATCH --array=1-1
#SBATCH --output=slurm_logs/rfa-diff_6M17_Receptor_Binding_Motif_Core_hsB_%A_%a.out
#SBATCH --error=slurm_logs/rfa-diff_6M17_Receptor_Binding_Motif_Core_hsB_%A_%a.err
...
--bind "/data/homezvol1/inagakit/Projects/initbinder/targets/6M17/designs/Receptor_Binding_Motif_Core/hs-B/rfa_rfdiff":/outputs \
--pwd /home \
...
bash -lc "
    ...
    echo 'Hotspots: E484,E481,E505,E500,E477'
    ...
    ppi.hotspot_res=[E484,E481,E505,E500,E477] \
