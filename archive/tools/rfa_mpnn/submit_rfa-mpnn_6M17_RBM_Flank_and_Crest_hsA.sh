#!/bin/bash
#SBATCH -J rfa-mpnn_6M17_RBM_Flank_and_Crest_hsA
#SBATCH -p gpu
...
INP="/data/homezvol1/inagakit/Projects/initbinder/targets/6M17/designs/RBM_Flank_and_Crest/hs-A/rfa_rfdiff"
...
singularity exec \
    ...
    --bind "/data/homezvol1/inagakit/Projects/initbinder/targets/6M17/designs/RBM_Flank_and_Crest/hs-A/rfa_rfdiff":/inputs \
    --bind "/data/homezvol1/inagakit/Projects/initbinder/targets/6M17/designs/RBM_Flank_and_Crest/hs-A/rfa_mpnn":/outputs \
    --pwd /home \
