#!/bin/bash
#SBATCH -J rfa-mpnn_3LZG_Conserved_Stem_Helix_hsA
#SBATCH -p gpu
...
INP="/data/homezvol1/inagakit/Projects/initbinder/targets/3LZG/designs/Conserved_Stem_Helix/hs-A/rfa_rfdiff"
...
singularity exec \
    ...
    --bind "/data/homezvol1/inagakit/Projects/initbinder/targets/3LZG/designs/Conserved_Stem_Helix/hs-A/rfa_rfdiff":/inputs \
    --bind "/data/homezvol1/inagakit/Projects/initbinder/targets/3LZG/designs/Conserved_Stem_Helix/hs-A/rfa_mpnn":/outputs \
    --pwd /home \
