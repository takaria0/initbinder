#!/bin/bash
#SBATCH -J rfa-mpnn_3LZG_Fusion_Peptide_Pocket_hsB
#SBATCH -p gpu
...
INP="/data/homezvol1/inagakit/Projects/initbinder/targets/3LZG/designs/Fusion_Peptide_Pocket/hs-B/rfa_rfdiff"
...
singularity exec \
    ...
    --bind "/data/homezvol1/inagakit/Projects/initbinder/targets/3LZG/designs/Fusion_Peptide_Pocket/hs-B/rfa_rfdiff":/inputs \
    --bind "/data/homezvol1/inagakit/Projects/initbinder/targets/3LZG/designs/Fusion_Peptide_Pocket/hs-B/rfa_mpnn":/outputs \
    --pwd /home \
