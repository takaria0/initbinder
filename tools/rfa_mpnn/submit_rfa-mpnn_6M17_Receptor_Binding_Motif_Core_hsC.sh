#!/bin/bash
#SBATCH -J rfa-mpnn_6M17_Receptor_Binding_Motif_Core_hsC
#SBATCH -p gpu
...
INP="/data/homezvol1/inagakit/Projects/initbinder/targets/6M17/designs/Receptor_Binding_Motif_Core/hs-C/rfa_rfdiff"
...
singularity exec \
    ...
    --bind "/data/homezvol1/inagakit/Projects/initbinder/targets/6M17/designs/Receptor_Binding_Motif_Core/hs-C/rfa_rfdiff":/inputs \
    --bind "/data/homezvol1/inagakit/Projects/initbinder/targets/6M17/designs/Receptor_Binding_Motif_Core/hs-C/rfa_mpnn":/outputs \
    --pwd /home \
