#!/bin/bash
#SBATCH --job-name=rfa-af3batch_6M17_RBM_Flank_and_Crest
#SBATCH --partition=gpu
#SBATCH -A ccl_lab_gpu
#SBATCH --gres=gpu:A30:1
#SBATCH --nodes=1 --ntasks=1 --cpus-per-task=1 --mem=48G
#SBATCH --array=1-1
#SBATCH --output=slurm_logs/rfa-af3batch_6M17_RBM_Flank_and_Crest_%A_%a.out --error=slurm_logs/rfa-af3batch_6M17_RBM_Flank_and_Crest_%A_%a.err
...
OUT_DIR="/data/homezvol1/inagakit/Projects/initbinder/targets/6M17/designs/RBM_Flank_and_Crest/hs-C/rfa_af3"
JOB_DIR="/data/homezvol1/inagakit/Projects/initbinder/tools/rfa_af3/6M17_RBM_Flank_and_Crest"

DESIGNS_LIST="/data/homezvol1/inagakit/Projects/initbinder/tools/rfa_af3/6M17_RBM_Flank_and_Crest/designs.list"
MANIFEST_TSV="/data/homezvol1/inagakit/Projects/initbinder/tools/rfa_af3/6M17_RBM_Flank_and_Crest/design_manifest.tsv"
...
SEED_JSON=$(ls "/data/homezvol1/inagakit/Projects/initbinder/targets/6M17/designs/RBM_Flank_and_Crest/hs-C/rfa_af3"/*/*_data.json | head -n 1 || true)
if [ -z "$SEED_JSON" ]; then
    echo "[ERR] Seed data.json not found under /data/homezvol1/inagakit/Projects/initbinder/targets/6M17/designs/RBM_Flank_and_Crest/hs-C/rfa_af3"
