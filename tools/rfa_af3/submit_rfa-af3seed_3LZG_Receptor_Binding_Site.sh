#!/bin/bash
#SBATCH --job-name=rfa-af3seed_3LZG_Receptor_Binding_Site
#SBATCH --partition=gpu
#SBATCH -A ccl_lab_gpu
#SBATCH --gres=gpu:A100:1
#SBATCH --nodes=1 --ntasks=1 --cpus-per-task=4 --mem=64G
#SBATCH --output=slurm_logs/rfa-af3seed_3LZG_Receptor_Binding_Site_%j.out --error=slurm_logs/rfa-af3seed_3LZG_Receptor_Binding_Site_%j.err

set -euo pipefail
echo "--- AF3 Stage1 (seed, full data pipeline) ---"
module load cuda/12.2.0 singularity

INPUT_JSON="/data/homezvol1/inagakit/Projects/initbinder/tools/rfa_af3/3LZG_Receptor_Binding_Site/design_1_0_dldesign_0_seed_input.json"
DESIGN_NAME="design_1_0_dldesign_0"
OUT_DIR="/data/homezvol1/inagakit/Projects/initbinder/targets/3LZG/designs/Receptor_Binding_Site/rfa_af3/design_1_0_dldesign_0"
mkdir -p "$OUT_DIR"
