#!/bin/bash
#SBATCH --job-name=rfa-diff_8SGU_Conserved_Cryptic_Site
#SBATCH --partition=gpu
#SBATCH -A ccl_lab_gpu
#SBATCH --gres=gpu:A100:1
#SBATCH --nodes=1 --ntasks=1 --cpus-per-task=4 --mem=32G
#SBATCH --array=1-1
#SBATCH --output=slurm_logs/rfa-diff_8SGU_Conserved_Cryptic_Site_%A_%a.out --error=slurm_logs/rfa-diff_8SGU_Conserved_Cryptic_Site_%A_%a.err
...
singularity exec \
    ...
    --bind "/data/homezvol1/inagakit/Projects/epitopeflow_rfa/targets/8SGU/designs/Conserved_Cryptic_Site/rfa_rfdiff":/outputs \
    --pwd /home \
    ...
    bash -c "echo 'Running RFAntibody RFdiffusion...'; \
                ...
                echo 'Designing for epitope: Conserved Cryptic Site'; \
                echo 'Total Designs: 2, Designs per Task: 5'; \
                echo 'Hotspots: A366,A367,A369,A370,A371,A372,A373,A374,A375,A376,A377,A378,A379,A380,A381,A382,A383,A384,A385,A386'; \
             ...
             poetry run python /home/src/rfantibody/rfdiffusion/rfdiffusion_inference.py \
                ...
                'ppi.hotspot_res=[A366,A367,A369,A370,A371,A372,A373,A374,A375,A376,A377,A378,A379,A380,A381,A382,A383,A384,A385,A386]' \
