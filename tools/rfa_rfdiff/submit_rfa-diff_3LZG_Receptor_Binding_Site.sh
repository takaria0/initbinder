#!/bin/bash
#SBATCH --job-name=rfa-diff_3LZG_Receptor_Binding_Site
#SBATCH --partition=gpu
#SBATCH -A ccl_lab_gpu
#SBATCH --gres=gpu:A100:1
#SBATCH --nodes=1 --ntasks=1 --cpus-per-task=4 --mem=32G
#SBATCH --array=1-1
#SBATCH --output=slurm_logs/rfa-diff_3LZG_Receptor_Binding_Site_%A_%a.out --error=slurm_logs/rfa-diff_3LZG_Receptor_Binding_Site_%A_%a.err
...
singularity exec \
    ...
    --bind "/data/homezvol1/inagakit/Projects/epitopeflow_rfa/targets/3LZG/prep":/inputs \
    --bind "/data/homezvol1/inagakit/Projects/epitopeflow_rfa/targets/3LZG/designs/Receptor_Binding_Site/rfa_rfdiff":/outputs \
    --pwd /home \
    ...
    bash -c "echo 'Running RFAntibody RFdiffusion...'; \
                ...
                echo 'Designing for epitope: Receptor Binding Site'; \
                echo 'Total Designs: 2, Designs per Task: 5'; \
                echo 'Hotspots: A134,A135,A136,A137,A190,A192,A193,A194,A196,A197,A198,A224,A225,A226,A227'; \
             ...
             poetry run python /home/src/rfantibody/rfdiffusion/rfdiffusion_inference.py \
                ...
                'ppi.hotspot_res=[A134,A135,A136,A137,A190,A192,A193,A194,A196,A197,A198,A224,A225,A226,A227]' \
