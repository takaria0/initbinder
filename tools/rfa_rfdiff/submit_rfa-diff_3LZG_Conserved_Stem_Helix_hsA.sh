#!/bin/bash
#SBATCH --job-name=rfa-diff_3LZG_Conserved_Stem_Helix_hsA
#SBATCH --partition=gpu
#SBATCH -A ccl_lab_gpu
#SBATCH --gres=gpu:A30:1
#SBATCH --nodes=1 --ntasks=1 --cpus-per-task=1 --mem=16G
#SBATCH --array=1-1
#SBATCH --output=slurm_logs/rfa-diff_3LZG_Conserved_Stem_Helix_hsA_%A_%a.out
#SBATCH --error=slurm_logs/rfa-diff_3LZG_Conserved_Stem_Helix_hsA_%A_%a.err
...
--bind "/data/homezvol1/inagakit/Projects/initbinder/targets/3LZG/designs/Conserved_Stem_Helix/hs-A/rfa_rfdiff":/outputs \
--pwd /home \
...
bash -lc "
    ...
    echo 'Hotspots: B76,B58,B63,B72,B47'
    ...
    antibody.target_pdb=/inputs/prepared_crop_Conserved_Stem_Helix_hs-A.pdb \
    antibody.framework_pdb=/home/scripts/examples/example_inputs/h-NbBCII10.pdb \
    inference.ckpt_override_path=/home/weights/RFdiffusion_Ab.pt \
    ppi.hotspot_res=[B76,B58,B63,B72,B47] \
