#!/bin/bash
#SBATCH --job-name=rfa-diff_3LZG_Conserved_Stem_Helix_hsB
#SBATCH --partition=gpu
#SBATCH -A ccl_lab_gpu
#SBATCH --gres=gpu:A30:1
#SBATCH --nodes=1 --ntasks=1 --cpus-per-task=1 --mem=16G
#SBATCH --array=1-1
#SBATCH --output=slurm_logs/rfa-diff_3LZG_Conserved_Stem_Helix_hsB_%A_%a.out
#SBATCH --error=slurm_logs/rfa-diff_3LZG_Conserved_Stem_Helix_hsB_%A_%a.err
...
--bind "/data/homezvol1/inagakit/Projects/initbinder/targets/3LZG/designs/Conserved_Stem_Helix/hs-B/rfa_rfdiff":/outputs \
--pwd /home \
...
bash -lc "
    ...
    echo 'Designing for epitope: Conserved Stem Helix'
    echo 'TASK_N (num designs this task): ' $TASK_N
    echo 'Hotspots: B58,A21,B72,B38,B62'
    ...
    antibody.target_pdb=/inputs/prepared_crop_Conserved_Stem_Helix_hs-B.pdb \
    antibody.framework_pdb=/home/scripts/examples/example_inputs/h-NbBCII10.pdb \
    inference.ckpt_override_path=/home/weights/RFdiffusion_Ab.pt \
    ppi.hotspot_res=[B58,A21,B72,B38,B62] \
