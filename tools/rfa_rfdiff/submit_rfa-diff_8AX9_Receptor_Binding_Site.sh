#!/bin/bash
#SBATCH --job-name=rfa-diff_8AX9_Receptor_Binding_Site
#SBATCH --partition=gpu
#SBATCH -A ccl_lab_gpu
#SBATCH --gres=gpu:A100:1
#SBATCH --nodes=1 --ntasks=1 --cpus-per-task=4 --mem=32G
#SBATCH --array=1-1
#SBATCH --output=slurm_logs/rfa-diff_8AX9_Receptor_Binding_Site_%A_%a.out --error=slurm_logs/rfa-diff_8AX9_Receptor_Binding_Site_%A_%a.err
...
singularity exec \
    ...
    --bind "/data/homezvol1/inagakit/Projects/initbinder/targets/8AX9/prep":/inputs \
    --bind "/data/homezvol1/inagakit/Projects/initbinder/targets/8AX9/designs/Receptor_Binding_Site/rfa_rfdiff":/outputs \
    --pwd /home \
    ...
    bash -c "echo 'Running RFAntibody RFdiffusion...'; \
                ...
                echo 'Total Designs: 5, Designs per Task: 5'; \
                echo 'Hotspots: A142,A136,A150,A146,A140'; \
             ...
             poetry run python /home/src/rfantibody/rfdiffusion/rfdiffusion_inference.py \
                ...
                'ppi.hotspot_res=[A142,A136,A150,A146,A140]' \
