...
- UI now includes a Bulk Processing section (index.html/app.js) for pasting CSVs, toggling actions, setting shared epitope guidance, using current design defaults, and importing design configs; job status pipes into the existing Job Activity log.
